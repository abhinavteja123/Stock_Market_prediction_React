        ...
        >
            ...
            <div style={{ position: 'relative', zIndex: 10, maxWidth: '800px', marginLeft: '4rem' }}>
                ...
                <motion.p
                    ...
                    style={{ fontSize: '1.25rem', color: 'var(--text-main)', maxWidth: '600px', lineHeight: 1.6, textShadow: '0 2px 10px rgba(0,0,0,0.5)' }}
                >
                    Deploy advanced ensemble neural networks to decode market volatility.
                    Visualize hidden feature correlations and generate high-confidence trading signals.
                </motion.p>
